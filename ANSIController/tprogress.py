...
class _ProgressManage:
    ...
    def ___fix_text_progress(self,text:Any) -> dict[str|int,dict] | list: # type: ignore
        ...
        if self.___isinstance(text,(dict,str)):
            if not isinstance(list(text.values())[0],dict):
    ...
    def ___fix_repeated_key(self,key:int|str) -> str|int:
        ...
        return key
    def __init__(self,progress:str | list | dict | list[str] | list[dict]=None) -> None:
        self.reset_progress(progress)
    def reset_progress(self,progress:str | list | dict | list[str] | list[dict]=None):
    ...
    def _fix_key(self, key: str | int | None,dec:bool=True,_str:bool=True) -> int | str:
        ...
        return str(key) if _str else key
    ...
    def get_progress_keys(self) -> list[str|int]:
        return [_k for _k in list(self._progress.keys())]
